MetacatUI.AppConfig = Object.assign({
  ...
  trustedContentSources: ["https://metamattj.shinyapps.io*"],
  ...
  allowAccessPolicyChangesDatasetsForSubjects: ["CN=DataONE-Support,DC=dataone,DC=org", "CN=drp-data-admins,DC=dataone,DC=org", "CN=drp-team,DC=dataone,DC=org"],
  allowAccessPolicyChangesPortals: true,
  allowAccessPolicyChangesPortalsForSubjects: ["CN=DataONE-Support,DC=dataone,DC=org", "CN=drp-data-admins,DC=dataone,DC=org", "CN=drp-team,DC=dataone,DC=org"],
